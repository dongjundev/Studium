        ...
        <div className="description-row-step">
          ...
          <form className="description-contents-all">
            ...
            <div>
              <div className="description-inputContainer">
                <form>
                    <textarea value={this.state.inputarea} id="description-textarea" minLength="10" name="inputarea" 
                      onChange={this.handleChange} cols="70" rows="10" placeholder="최소 10자 이상 작성해 주세요.">
                    </textarea>
                </form>
              </div>
              <ul>
          ...
          <div className="description-Footer">
            <div className="description-Footer-box">
              <Link to="../">
                <button className="save-btn" disabled={this.state.inputarea.length<10}  onClick={this.sendStudyData}>다음</button>
